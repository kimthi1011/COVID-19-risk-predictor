...
write.csv(information_values, file ="/data/project/ubrite/covid19-hackathon/Team4_staging_area/intermediate_results/icd10_period_2weeks/icd10_period_2week_iv.csv")

# filter variable via missing rate, iv, identical value rate
all_data_f = var_filter(all_data, y="target", positive=0)
...
# score ------
## scorecard
card = scorecard(bins_adj, m2, points0 = 600, odds=1/5, pdo=50)
