...
all_condition_data = rbind(positive_data_df,negative_data_df)
...
write.csv(information_values, file ="/data/project/ubrite/covid19-hackathon/Team4_staging_area/intermediate_results/icd10_groups_iv.csv")
