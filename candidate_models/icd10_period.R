...
# data preparing ------
# load data
positive_data = read.csv(file = '/data/project/ubrite/covid19-hackathon/Team4_staging_area/parsed_data/positive_period_group_categorical.csv')
negative_data = read.csv(file = '/data/project/ubrite/covid19-hackathon/Team4_staging_area/parsed_data/negative_period_group_categorical.csv')
...
write.csv(information_values, file ="/data/project/ubrite/covid19-hackathon/Team4_staging_area/intermediate_results/icd10_period_iv.csv")
...
# score ------
## scorecard
card_all_time = scorecard(bins, m2, points0 = 600, odds=1/50, pdo=50)

## credit score
score_list = lapply(dt_list, function(x) scorecard_ply(x, card_all_time))
## psi
